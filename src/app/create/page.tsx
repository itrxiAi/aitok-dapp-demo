...
export default function CreatePost() {
  ...
  const uploadProps = {
    ...
    beforeUpload: (file: File) => {
      ...
      if (!ALLOWED_FILE_TYPES[file.type]) {
        message.error(
          "You can only upload images (JPG, PNG, GIF) or videos (MP4, MOV)!"
        );
        return false;
      }
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        <Card
          title={<span style={{ color: "#ffffff" }}>Create New Post</span>}
          style={{
            background: "rgba(0,0,0,0.05)",
            border: "1px solid rgba(255,255,255,0.1)",
            color: "#ffffff",
          ...
          <Form form={form} layout="vertical" onFinish={handleSubmit}>
            ...
            <Form.Item name="media">
              ...
              >
                ...
                <p className="ant-upload-hint" style={{ color: "#cccccc" }}>
                  Support for a single image file (max 2MB) or video file (max
                  50MB).
                </p>
              </Dragger>
            </Form.Item>
            ...
            >
              <Checkbox style={{ color: "#ffffff" }}>
                Make this post visible to unfollowed users
              </Checkbox>
            </Form.Item>
      ...
      <style jsx global>{`
        ...
        .custom-textarea .ant-input::-webkit-input-placeholder {
          color: #cccccc !important;
        }
        .custom-textarea .ant-input::-moz-placeholder {
          color: #cccccc !important;
        }
        .custom-textarea .ant-input:-ms-input-placeholder {
          color: #cccccc !important;
        }
      `}</style>
    </div>
